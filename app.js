...
document.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var inputTask, inputTaskList, taskButton, addTask, fetchData, main;
    var _this = this;
    return __generator(this, function (_a) {
        inputTask = document.getElementById('newTask');
        inputTaskList = document.getElementById('taskList');
        taskButton = document.getElementById('addTaskBtn');
        addTask = function () {
            if (inputTask.value === '') {
        ...
        main = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        console.error('Error initializing tasks:', error_2);
                        return [3 /*break*/, 3];
